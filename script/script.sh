...
echo -e "\n--- Restarting Apache ---\n"
#Ubuntu: service apache2 restart > /dev/null 2>&1
...
cd /var/www && mkdir YiiTest && cd YiiTest 
composer create-project yiisoft/yii2-app-advanced advanced 2.0.7 > /dev/null 2>&1
